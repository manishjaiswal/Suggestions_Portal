...
public partial class allsuggestions : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        // Response.Write(LoginClass.CheckLogin);
    ...
    protected void gv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Onclickb")
        {
            ...
            int ProductID = Convert.ToInt32(gv.DataKeys[RowClicked].Value);            
            Page.Response.Redirect("viewsuggestion.aspx?text=" + ProductID);
