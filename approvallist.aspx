...
<head runat="server">
    <title>Suggestions for Approval</title>
...
<body style="background-image: url('Images/jets.png'); background-size: 100% 100%; background-repeat: no-repeat;">
    <form id="form1" runat="server">
        ...
        <div style="width: 67%; float: left;">
            <center>
                <br />
                <a class="halsug">Suggestions to be Approved</a> 
                <br /><br />           
            </center>
        </div>
        ...
        <div class="content">
            <asp:LinqDataSource ID="LinqDataSourceTable" runat="server" ContextTypeName="dataclassDataContext" EntityTypeName="" TableName="Tables" Where="status == @status" OrderBy="date_time desc">
                <WhereParameters>
                    <asp:SessionParameter Name="status" SessionField="usrtyp" Type="Int32" />
                </WhereParameters>
            </asp:LinqDataSource>
            <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" DataKeyNames="suggestionid" DataSourceID="LinqDataSourceTable" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="gv_RowCommand" AllowPaging="True" AllowSorting="True" Width="1100px" Height="172px">
